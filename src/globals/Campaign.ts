...
export const Campaign: GlobalConfig = {
  ...
  fields: [
    ...
    { name: 'currentSession', type: 'number' },
    {
      ...
      type: 'text',
      localized: true,
      admin: { description: 'In-world era badge, e.g. "Yr 350".' },
    },
    {
      name: 'currentInWorldDate',
      type: 'text',
      localized: true,
    ...
    },
    {
      ...
      type: 'text',
      localized: true,
      admin: { description: 'Where the Choir is right now, e.g. "Aureth, capital of Aurion".' },
    },
    {
      name: 'holding',
      type: 'text',
      localized: true,
      admin: { description: 'What they are waiting on right now.' },
    },
